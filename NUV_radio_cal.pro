...
SAVE, v, parameters, filename=path+'/analysis/'+ obs_tag+'/cal_'+linid+ '_parameters.sav'
; -----------------------------------------------
...
PLOT, v, parameters[0,*,*], PSYM=3, $ 
	...
	CHARSIZE=2
scrncap = TVRD(TRUE=1)
WRITE_PNG, path+'/analysis/'+obs_tag+'/calibrated_plot_FULL.png', scrncap
